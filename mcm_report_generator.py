...
class PDFReportGenerator:
    ...
    def create_cover_page_story(self):
        ...
        try:
            ...
            title3_style = ParagraphStyle(name='Title3', parent=title_style, fontSize=30, fontName='Helvetica-Oblique')
            title4_style = ParagraphStyle(name='Title4', parent=title_style, fontSize=20, fontName='Helvetica-Oblique')
