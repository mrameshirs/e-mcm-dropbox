            ...
            with st.spinner("Generating Short PDF Summary... Please wait."):
                ...
                if df_mcm_current is not None and not df_mcm_current.empty:
                    ...
                    mcm_columns = [
                        ...
                        'revenue_recovered_lakhs_rs', 'revenue_involved_rs','revenue_recovered_rs','status_of_para', 'mcm_decision', 'chair_remarks','total_amount_detected_overall_rs','total_amount_recovered_overall_rs'
                    ]
