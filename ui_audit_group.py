...
def view_uploads_tab(dbx):
    ...
    with st.spinner("Loading your uploaded reports..."):
        ...
        # --- MODIFIED: Inject more forceful CSS for a colorful table ---
        table_css = """
        <style>
            .view-table {
                width: 100%;
            ...
            .view-table thead tr {
                background-color: #16a085 !important; /* Teal header */
            ...
            .view-table tbody tr:hover {
                background-color: #d4edda !important; /* Light green hover */
                cursor: pointer;
            }
        </style>
        """
